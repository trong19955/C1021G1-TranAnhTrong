...
public class ProductRepository implements IProductRepository {
    ...
    private static final String SEARCH_PRODUCT_BY_ID = "select * from product join category on product.id_category = category.id_category" +
            " where id = ?;";
    private static String SELECT_PRODUCT_BY_ID = "select * from product join category on product.id_category = category.id_category" +
            " where id = ?;";
    private static String EDIT_PRODUCT = "UPDATE product set id_category =?, name =?, price=?," +
            "quantity=?, color=? where id =?";
        ...
        if (connection != null) {
            try {
                ...
                while (resultSet.next()) {
                    ...
                    product = new Product(idProduct, name, price, quantity, color, idCategory, nameCategory);
