...
<a class="btn btn-success" href="/product?action=list"><i class="material-icons">&#xe8ba;</i>Back to product</a>
<a class="btn btn-success" href="/product?action=create"><i style='font-size:24px' class='fas'>&#xf2bb;</i>Add new product</a>
<table id="product" class="table table-striped table-bordered" style="width:70% ">
    ...
    <c:forEach var="product" items='${requestScope["product"]}'>
        <tr>
            ...
            <td>
                <button class="btn btn-warning"><a href="/product?action=edit&id=${product.id}">
                    <i style='font-size:24px' class='fas'>&#xf044;</i>Edit</a></button>
